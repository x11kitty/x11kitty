...
<div align="center">
  ...
  <table border="0">
    <tr>
      <td align="center" style="border: 2px solid #89DCEB; border-radius: 12px; padding: 25px; background-color: #1e1e2e; color: #89DCEB;">
        <span style="font-family: 'Fira Code', monospace; font-size: 1.2em;">
